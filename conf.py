...
# Kasper Junge build configuration file, created by
# `ablog start` on Fri Feb 14 11:33:24 2025.
#
...
blog_authors = {
    "Kasper Junge": ("Kasper Junge", None),
}
